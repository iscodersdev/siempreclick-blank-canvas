...
class FadeAnimation2 extends StatefulWidget {
  final double delay;
  final Widget child;
  ...
  @override
  _FadeAnimation2State createState() => _FadeAnimation2State();
}

class _FadeAnimation2State extends State<FadeAnimation2>
